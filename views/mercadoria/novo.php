<div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Cadastro Mercadoria > novo</h2>
          ...
          <div class="x_content">
            ...
            <form id="form-mercadoria" data-parsley-validate="" class="form-horizontal form-label-left" method="POST" action="<?php echo BASE_URI ?>mercadoria/salvar/0" >
              ...
              <div class="form-group">
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                  <input type="text" id="codigo-mercadoria-input" name="codigo-mercadoria-input" required="required" class="form-control col-md-3 col-xs-3">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                  <input type="text" id="nome-mercadoria-input" name="nome-mercadoria-input" required="required" class="form-control col-md-3 col-xs-3">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                  <input type="text" id="quantidade-mercadoria-input" name="quantidade-mercadoria-input" required="required" class="form-control col-md-3 col-xs-3">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                  <input type="text" id="preco-mercadoria-input" name="preco-mercadoria-input" required="required" class="form-control col-md-3 col-xs-3">
                </div>
              </div>
