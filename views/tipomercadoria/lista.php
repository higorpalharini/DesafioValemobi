          ...
          <div class="x_content">
            ...
            <div class="col-sm-12">
              <table id="datatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                <thead>
                  <tr role="row">
                    <th class="text-center" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 267px;">ID Tipo Mercadoria</th>
                ...
                <tbody>
                  <?php foreach($tiposMercadoria as $tipo) {?>
                  <tr role="row" class="odd">
                    <td class="text-center"><?php echo $tipo->getIdTipoMercadoria(); ?></td>
                    <td class="text-center"><?php echo $tipo->getDescricao(); ?></td>
                    <td class="text-center">
                      
                      <div class="btn-group" data-toggle="">
                        <label class="btn-default">
                          <a href="<?php echo BASE_URI ?>tipomercadoria/editar/<?php echo $tipo->getIdTipoMercadoria() ?>"><i class="fa fa-edit"></i> Editar</a>
                        </label>
                      </div>
                    </td>
                  </tr>
